...
var AppendStream = function (_Transform) {
  ...
  _createClass(AppendStream, [{
    ...
    value: function _writeToAppendBlobFromText(container, key, data, azropts, cb) {
    ...
    value: function _transform(data, enc, next) {
      ...
      var key = _opts.key;
      var azropts = _opts.azropts;


      this._writeToAppendBlobFromText(container, key, data, azropts, function (err, res, resp) {
